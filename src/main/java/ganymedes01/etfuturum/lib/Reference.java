...
public class Reference {
	...
	public static final String MOD_NAME = "EtFR Hx";
	...
	public static final String DEPENDENCIES = "required-after:Forge@[10.13.4.1614,);after:gtnhlib;after:Thaumcraft@[4.2.3.5,);after:TwilightForest;after:HardcoreEnderExpansion;after:bluepower;after:MineTweaker3;after:TConstruct;after:witchery;after:BiomesOPlenty";
	...
	public static final String VERSION_URL = System.getProperty("etfuturum.versionUrl", "https://raw.githubusercontent.com/GTNewHorizons/Et-Futurum-Requiem/master/updatejson/update.json");
	...
	public static final String GITHUB_URL = "https://github.com/GTNewHorizons/Et-Futurum-Requiem";
